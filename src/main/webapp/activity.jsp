...
<link
	...
	rel="stylesheet">
<link
	href="${contextPath}/resources/vendor/datatables/buttons.dataTables.min.css"
	rel="stylesheet">
					...
					<div class="row">
						...
						<div class="col-xl-10 col-md-6 mb-4">
							<div class="card border-primary shadow">
											...
											<div class="card-body">
												<h3 class="h4 mb-0 text-gray-800">User Activity</h3>
													<br>
												<div class="row no-gutters align-items-center">
													<div class="table-responsive">
														<table class="table table-bordered" id="activityDataTable"
...
<div class="modal fade" id="userProfile" tabindex="-1" role="dialog" aria-labelledby="Bill Confirmation" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
	...
	<script	src="${contextPath}/resources/vendor/datatables/buttons.flash.min.js"></script>
	<script	src="${contextPath}/resources/vendor/datatables/jszip.min.js"></script>
	<script	src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js"></script>
	<script	src="${contextPath}/resources/vendor/datatables/vfs_fonts.js"></script>
	<script	src="${contextPath}/resources/vendor/datatables/buttons.html5.min.js"></script>
	<script	src="${contextPath}/resources/vendor/datatables/buttons.print.min.js"></script>

	<!-- Page level custom scripts -->
	<script src="${contextPath}/resources/js/activity.js"></script>
