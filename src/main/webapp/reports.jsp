...
$(document).ready(function(){
	alert("Unable to load report generator due to lack of data");
      ...
      <div id="content">
        ...
        <div class="row">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
		  	  	<h1 class="h3 mb-0 text-gray-800">Reports</b></h1>
          </div>
        </div>
        </div>
        <!-- Begin tabs -->
...
<div class="card">
					      <div class="card-body">
					      <h1 class="h6 mb-0 text-gray-800">Generate reports</h1>
					      <hr></hr>
					      </div>
					      </div>
